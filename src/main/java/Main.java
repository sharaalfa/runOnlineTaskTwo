...
public class Main {
    ...
    static {
        DOMConfigurator.configure("/home/innopolis/Documents/lessionCarShop/src/main/resources/log4j.xml");
    }

    public static void main(String[] args) throws CarNotFoundException {
        Store store = new Store();
        logger.trace(new models.UserObject("Artur", "Sharafutdinov", "977520XXXX"));
